...
#include "ui_personalcardscreen.h"
#include "dbmanager.h"
#include <QSqlTableModel>
#include <QLayout>

PersonalCardScreen::PersonalCardScreen(QString& personal_id, QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PersonalCardScreen)
{
    ui->setupUi(this);
...
PersonalCardScreen::~PersonalCardScreen()
{
    delete ui;
}

QChartViewer* PersonalCardScreen::drawRadar(QSqlTableModel *model) {
...
BaseChart* PersonalCardScreen::stackradar(int, const char **imageMap, QSqlTableModel *model)
{
